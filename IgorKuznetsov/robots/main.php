...
<div>
    <article id="article-1" class="article">
        <h1 class="article-head">Robot`s Name</h1>
        <img src="img/robo1.jpg" class="robo-img" alt="Robot" title="Robot"><br>
        ...
        <p class="article-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            ...
            praesentium rerum ullam voluptates. Aliquam enim fuga harum nemo officia!
        </p>
    </article>

    <form name="robo-form" method="get" enctype="multipart/form-data">
